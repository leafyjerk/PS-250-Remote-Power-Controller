[README.md](https://github.com/user-attachments/files/29991999/README.md)
...
- **Steam Controller wake** — power the machine on by pressing the **Steam button** on a
  ...
  [Steam Controller wake: how it works](#steam-controller-wake-how-it-works).
...
4. **Steam Controller:** pair the controller to its puck **before** relying on the wake
